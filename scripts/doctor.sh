...
for command_name in nix brew git gh codex claude grok omp pi opencode omlx ghostty herdr nvim starship fzf mise uv bun vips gh-axi chrome-devtools-axi lavish-axi quota-axi tasks-axi treehouse no-mistakes; do
