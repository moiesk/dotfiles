...
for command_name in nix brew git gh codex claude pi opencode ghostty herdr nvim starship fzf mise uv bun gh-axi chrome-devtools-axi lavish-axi quota-axi treehouse no-mistakes; do
