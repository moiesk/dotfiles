...
OpenCode's [official plugin documentation](https://github.com/anomalyco/opencode/blob/v1.18.30/packages/web/src/content/docs/plugins.mdx)
and [config bootstrap](https://github.com/anomalyco/opencode/blob/v1.18.30/packages/opencode/src/config/config.ts)
...
At the current pin, its [runtime root](https://github.com/anomalyco/opencode/blob/v1.18.30/packages/plugin/src/index.ts)
